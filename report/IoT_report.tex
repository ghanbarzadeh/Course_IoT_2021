...
\title{Computer Homework \#4} % Assignment title

\author{Armin Ghanbarzadeh 9916184} % Student name

\date{12 Dec, 2021} % Due date
...
\class{Machine Vision} % Course or class name

\instructor{Dr. Abrishami Moghadam} % Professor or teacher in charge of the assignment
